...
const getBlogPost = (slug: string): BlogPost | null => {
  const posts: BlogPosts = {
    ...
    'interview-dj-pulse': {
      title: "Interview with DJ Pulse",
      excerpt: "An exclusive interview with the rising star of electronic music.",
      date: "2023-06-20",
      image: "https://images.pexels.com/photos/3755378/pexels-photo-3755378.jpeg",
      author: "Sarah Chen",
      category: "Interviews",
      content: `
        <p>In this exclusive interview, we sit down with DJ Pulse to discuss his journey in electronic music and his upcoming projects.</p>
          ...
          <div className="bg-purple-900/40 backdrop-blur-sm rounded-lg shadow-xl p-6 md:p-8">
            <div className="flex flex-wrap justify-between items-center mb-8 pb-8 border-b border-purple-800">
              ...
              <div className="mt-4 md:mt-0">
                <span className="inline-block bg-purple-800 text-white px-3 py-1 rounded-full text-sm">
                  {post.category}
                </span>
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-purple-800">
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-purple-700 flex items-center justify-center text-white font-bold text-xl">
